...
```{r psexo_xpais , fig.pos='H', fig.align='center', fig.height=3.3, dpi=200, fig.cap="Gráfico barras, Estimación de la proporción de mujeres que comienzan a tener relaciones sexuales antes de los 18 años por país."}
...
```{r psexo_xcat_riqueza , fig.pos='H', fig.align='center', fig.height=4, dpi=250, fig.cap="Gráfico barras, Estimación de la proporción de mujeres que comienzan a tener relaciones sexuales antes de los 18 años por categría de riqueza."}
...
```{r psexo_xtv , fig.pos='H', fig.align='center', fig.height=4, dpi=250, fig.cap="Gráfico barras, Estimación de la proporción de mujeres que comienzan a tener relaciones sexuales antes de los 18 años por si poseen o no un televisor en su hogar."}
...
```{r vip_phijo ,  fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico barras, importancia de las variables consideradas en el modelo de Random Forest mediante permutación para predecir la edad al primer hijo."}
...
```{r tune_bagging_phijo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico, resultados de la búsqueda de hiperparámetros para modelos de Bagging."}
...
```{r tune_rf_phijo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico, resultados de la búsqueda de hiperparámetros para modelos de Random Forest."}
...
tibble(tree_depth=c(1,15),
  ...
  kable_styling(latex_options = "striped", font_size = 10, position = "center")
```
...
```{r comp_modelos_phijo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico comparación de los modelos de Bagging, Random Forest y XGBoost para predecir la edad al primer hijo."}
...
```{r res_modelo_phijo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico residuos vs predichos, conjunto de entrenamiento."}
...
fit_test_phijo %>% group_by(pais) %>% metricas_reg(truth = edad_phijo, estimate = .pred) %>%
  ...
  kable_styling(latex_options = "striped", font_size = 14, position = "center")
```
...
```{r vip_fit_phijo , fig.pos='H', fig.align='center', fig.height=3, dpi=250, fig.cap="Gráfico barras, importancia de las variables consideradas en el modelo final."}
...
```{r pdp_educ , fig.pos='H', fig.align='center', fig.height=3, dpi=250, fig.cap="Gráfico PDP, efecto de los años de educación en la edad al primer hijo."}
...
```{r pdp_pais , fig.pos='H', fig.align='center', fig.height=3.5, dpi=200, fig.cap="Gráfico PDP, efecto del país en la edad al primer hijo."}
...
```{r vip_psexo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico barras, importancia de las variables consideradas en el modelo de Random Forest mediante permutación para predecir si comienza a tener relaciones luego de los 18 años."}
...
```{r tune_bagging_psexo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico, resultados de la búsqueda de hiperparámetros para modelos de Bagging."}
...
```{r tune_rf_psexo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico, resultados de la búsqueda de hiperparámetros para modelos de Random Forest."}
...
```{r comp_modelos_psexo , fig.pos='H', fig.align='center', fig.height=3.5, dpi=250, fig.cap="Gráfico comparación de los modelos de Bagging, Random Forest y Regresión Logística, mediante validación cruzada."}
...
```{r comp_roc_psexo , fig.pos='H', fig.align='center', fig.height=3, dpi=250, fig.cap="Gráfico, comparación curvas ROC para los modelos considerados en el conjunto de testeo."}
...
```{r conf_mat , fig.pos='H', fig.align='center', fig.height=2.5, dpi=200, fig.cap="Matriz de confusión para el modelo de Random Forest en el conjunto de testeo."}
...
```{r pdp_educ_psexo , fig.pos='H', fig.align='center', fig.height=4, dpi=250, fig.cap="Gráfico PDP, efecto de los años de educación en la probabilidad de comenzar a tener relaciones sexuales luego de los 18 años."}
...
```{r pdp_ind_riq_psexo , fig.pos='H', fig.align='center', fig.height=4, dpi=250, fig.cap="Gráfico PDP, efecto del indice de riqueza en el hogar en la probabilidad de comenzar a tener relaciones sexuales luego de los 18 años."}
...
```{r pdp_pais_psexo , fig.pos='H', fig.align='center', fig.height=4, dpi=250, fig.cap="Gráfico PDP, efecto del pais de la mujer en la probabilidad de comenzar a tener relaciones sexuales luego de los 18 años."}
