...
[HABLAR UN POCO DEL DISEÑO MUESTRAL Y QUE SE CONTEMPLA EN EL ANALISIS EXPLORATORIO Y SE OPTO POR NO CONSIDERARLO EN LOS MODELOS]

## Edad al primer hijo

[HAY QUE ACTUALIZAR EL TEXTO Y LOS GRAFICOS A LOS ULTIMOS DATOS UTILIZADOS, HACER GRAFICOS SOLO DE LAS VARIABLES QUE SE VEAN MAS IMPORTANTES EN EL RF]
...
[MUESTRA QUE LA RIQUEZA DEL HOGAR ES UNA VARIABLE IMPORTANTE COMO SE ATRASA A MEDIDA QUE EL HOGAR ES MAS RICO SOBRE TODO PARA ALGUNOS PAISES]
...
[HABLAR QUE LAS MUJERES CON MAS UNIONES TIENDEN A TENER HIJOS MAS JOVENES Y QUE MAS PAREJAS SEXUALES INDICA UNA LEVE TENDENCIA A TENER HIJOS MAS JOVENES PARA MUJERES SIN CASAR O CON MAS DE UNA UNION, MENCIONAR QUE LAS MUJERES CON UNA SOLA UNION TIENDEN A ESTAR CONCENTRADAS EN 20 AÑOS ]
```{r comp_parejas}
...
[HABLAR DE QUE SE REALIZA UN RF PARA DETERMINAR IMPORTANCIA DE VARIABLES, SELECCIONANDO LAS MAS RELEVANTES]

[CAPAZ MENCIONAR QUE LO DE QUE LA EDAD A LA PRIMERA RELACIÓN SEXUAL NO SE CONSIDERA YA QUE NO TIENE DEMASIADO SENTIDO PARA LA UTILIDAD DEL MODELO]

[MENCIONAR LA CANTIDAD DE DATOS UTILIZADOS, LA CANTIDAD DE DATOS PARA ENTRENAR Y QUE SE DIVIDEN TENIENDO ENCUENTA LOS PAISES (STRATA=PAIS)]
...
[MENCIONAR QUE SE TUNEA (MTRY Y MIN_N) EL RF PARA OBTENER LA IMPORTANCIA CON CV PERO SIN AFINAR MUCHO LA GRILLA Y QUE SE USAN 1000 ARBOLES]
...
[HABLAR UN POCO DE LAS VARIABLES QUE QUEDAN, MENCIONAR QUE SE TOMAN LAS MAS IMPORTANTES (POR EJEMPLO 10)]
...
[MENCIONAR QUE ES UNA VARIABLE MUY RELACIONADA A LA EDAD AL PRIEMR HIJO CON LO QUE LAS COVARIABLES MAS RELEVANTES EN GENERAL SON LAS MISMAS]
...
[COMENTAR EL ANALISIS EXPLORATORIO]
...
[HABLAR UN POCO DE LAS VARIABLES QUE QUEDAN, MENCIONAR QUE SE TOMAN LAS MAS IMPORTANTES]
