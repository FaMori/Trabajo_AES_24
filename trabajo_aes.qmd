...
Previo a la división de los datos se procede por filtrar observaciones con valores extremadamente atípicos o que podrían carecer de sentido, en este caso se toma como límite inferior de la edad a la primera relación sexual los 9 años.
Con lo que se cuentan con 49349 observaciones donde nuevamente se utilizará un 85% de los datos para entrenar y el 15% restante para evaluar los modelos considerados. 
...
En cuanto al pais de residencia de la mujer como se observo en el análisis exploratorio, es esperable que paises como Albania o Armenia presenten una mayor probabilidad de comenzar a tener relaciones sexuales luego de los 18 años. En la @fig-pdp_pais_psexo se observa algo razonable con lo visto donde Armenia y Albania están por encima del resto de los paises.
